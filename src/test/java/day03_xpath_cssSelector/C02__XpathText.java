...
public class C02__XpathText {
    ...
    public static void main(String[] args) throws InterruptedException {WebDriver driver = new ChromeDriver();
        ...
        driver.findElement(By.xpath("//*[text()='Add Elements']")).click();
        //3- Delete butonu’nun gorunur oldugunu test edin
        WebElement deleteButonElementi= driver.findElement(By.xpath("//*[text()='Add/Remove Elements']"));
        ...
        if (((WebElement) addRemoveElementi).isDisplayed()){
